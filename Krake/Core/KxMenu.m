...
- (UIView *) mkContentView
{
    ...
    for (KxMenuItem *menuItem in _menuItems) {
        ...
        if (menuItem.enabled) {
            ...
            [button setBackgroundImage:[UIImage imageOBJC:[[KTheme currentObjc] color: ColorStyleSelected] size: CGSizeMake(1, 1)] forState:UIControlStateHighlighted];
        ...
        if (menuItem.title.length) {
            ...
            titleLabel.textColor = [[KTheme currentObjc] color: ColorStylePopoverText];
        ...
        if (menuItem.image) {
            ...
            imageView.tintColor = [[KTheme currentObjc] color: ColorStylePopoverText];
             ...
             inContext:(CGContextRef) context
{
    ...
    UIColor *backgroundColor = [[KTheme currentObjc] color: ColorStylePopoverBackground];
    ...
    CGContextFillRect(context, (CGRect){CGPointZero, frame.size});

...
- (NSArray*) valueArrayForStartValue:(float)startValue endValue:(float)endValue;
...
- (void) setNumberOfBounces:(NSUInteger)newNumberOfBounces {
    [super setValue:[NSNumber numberWithUnsignedLong:newNumberOfBounces] forKey:@"numberOfBouncesKey"];
    [self createValueArray];
}

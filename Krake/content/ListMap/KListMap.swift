            ...
            if currentNumberOfSections > 0 && datasourceNumberOfSection == 1
            {
                ...
                if numberOfObjectsChanged == 0 {
                    if let items = collectionView?.indexPathsForVisibleItems, items.count > 0 {
                        ...
                        if currentPage.uintValue <= 1, collectionView(collectionView, numberOfItemsInSection: 0) > 0 {
                ...
                else
                {
                    collectionView?.performBatchUpdates({
                        ...
                        if currentPage.uintValue <= 1, mySelf.collectionView(mySelf.collectionView, numberOfItemsInSection: 0) > 0 {
